        ...
        <div class="box-content">
          <div class="col-lg-8 offset-lg-2">
            <div class="box-header" data-original-title>
              ...
              <br>
              <span>Please select the number of Category(s) to create</span>
              <select id="num">
                  @for ($i = 0; $i < 7; $i++)
          ...
          <form class="form-horizontal" action="{{ url('/save-category') }}" method="POST" enctype="multipart/form-data">
              ...
              <fieldset>
                  ...
                  <div class="text-center form-actions sm-6">
                      <button class="btn btn-primary submit-btn">Add Category(s)</button>
                  </div>
              </fieldset>
          </form>
        </div>
      ...
      num.onchange = () => {
          ...
          var i = 0
              ...
              var chd = '<div id="form" class="col-lg-8 offset-lg-5" style="border-bottom: 2px purple dotted; margin-top: 10px">'
                  ...
                  chd +=        '<label class="control-label" for="date01">Category Name</label>'
                  chd +=      '<div class="controls">'
                  chd +=          '<input class="input-xlarge" type="text" name="category_name[]">'
                  chd +=      '</div>'
                  chd +=    '</div>'
                  chd +=    '<div class="control-group">'
                  chd +=      ' <label class="control-label" for="textarea2">Category Description</label>'
                  chd +=      '<div class="controls">'
                  chd +=          '<textarea rows="3" class=""  name="category_description[]"></textarea>'
                  chd +=      '</div>'
                  chd +=    '</div>'
