...
Route::get('/product_by_brand/{manufacture_id}','HomeController@show_product_by_manufacture');
...
Route::get('/prescription-list', 'SendPharmNotification@prescription_list');
Route::get('/view-prescription/{prescription_id}', 'SendPharmNotification@view_prescription');
Route::get('/delete-prescription/{prescription_id}', 'SendPharmNotification@delete_prescription');

//checkout

Route::get('/login-check','CheckoutController@login_check');
Route::get('/register-check','CheckoutController@register_check');
...
Route::get('/upload-prescription/{item_id}', 'CheckoutController@upload_prescription');
Route::post('/upload-prescription/{item_id}', 'CheckoutController@upload_prescription_handler');
...
if($q != " "){
    ...
    $manage_product_by_category=view('pages.search_result',['hasRecord'=>true,'all_published_product'=>$product_by_category]);
